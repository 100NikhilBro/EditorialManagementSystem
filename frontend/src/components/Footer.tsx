...
const FooterLinkColumn: React.FC<{ title: string; links: { text: string; href: string }[] }> = ({ title, links }) => (
  <div>
    <h4 className="font-semibold mb-3 text-sm text-white tracking-wide border-b border-gray-600 pb-1">
      {title}
    </h4>
...
const Footer: React.FC = () => {
  const footerLinks = {
    authors: [
      ...
      { text: "Track Submitted Paper", href: "#" },
      { text: "Publication Ethics", href: "#" },
      { text: "Author Support", href: "#" },
    ],
    editors: [
      { text: "Editorial Policies", href: "#" },
      { text: "Review Process", href: "#" },
      { text: "Guest Editor Guidelines", href: "#" },
    ],
    reviewers: [
      { text: "Reviewer Guidelines", href: "#" },
      { text: "Review Recognition", href: "#" },
    ],
  };
      ...
      <div className="border-t border-gray-700 px-6 py-6 max-w-6xl mx-auto text-xs">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="text-gray-500">
            © {new Date().getFullYear()} Journal Management System. All rights reserved.
          </div>
        </div>

        {/* Extra Govt Line */}
        <div className="text-center mt-4 text-gray-500">
          This is an official academic platform. Unauthorized use or reproduction of content is strictly prohibited.
        </div>
